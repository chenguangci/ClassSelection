    ...
    <script>
        $(document).ready(function(){
            $("#addTable").click(function(){
                var tr="<tr><td><input type=\"text\" class=\"basic-slide\" name=\"courseNo\"></td>"+
                    "<td><input type=\"text\" class=\"basic-slide\" name=\"courseName\"></td>"+
                    "<td><input type=\"text\" class=\"basic-slide\" name=\"coursePriorNo\"></td>"+
                    "<td><input type=\"text\" class=\"basic-slide\" name=\"courseCredit\"></td>"+
...
<body>
<div class="left"><a href="selectCourse.action"><img src="${path}/resource/image/return.png" width="110" height="45"></a></div>
<div>
<form method="post" action="insertCourse.action" id="form1">
