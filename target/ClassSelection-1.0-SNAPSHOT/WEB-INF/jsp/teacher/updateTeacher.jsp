...
<form action="updateTeacher.action" method="post">
    <input type="hidden" name="studentNo" value="<%=teacher.getTeacherNo()%>">
    学号：<%=teacher.getTeacherNo()%><br>
    ...
    所授课程1：<input type="text" name="courseNo1" value="<%=teacher.getCourseNo1()%>"><br>
    所授课程2：<input type="text" name="courseNo2" value="<%=teacher.getCourseNo2()%>"><br>
    所授课程3：<input type="text" name="courseNo3" value="<%=teacher.getCourseNo3()%>"><br>
